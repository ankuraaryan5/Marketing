      ...
      >
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          ...
          >
            ...
            readers and inspire action. Perfectly tailored for your audience and brand voice.
          </motion.p>
          <motion.a
            href="/contact"
      ...
      <section className="max-w-6xl mx-auto mt-20 grid md:grid-cols-2 lg:grid-cols-4 gap-10 px-6">
        {[
          ...
          >
            ...
            <h4 className="text-xl font-bold mb-2 text-purple-800">{item.title}</h4>
  ...
  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
    {[
      ...
      >
        ...
        <h4 className="text-xl font-bold text-purple-700 mb-2">{item.title}</h4>
        <p className="text-gray-600">{item.desc}</p>
      </motion.div>
    ))}
  </div>
        ...
        <section className="mt-24 text-center px-6">
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Let's plan your editorial calendar and create content that drives results.
          </motion.p>
          <motion.a
            href="/contact"
