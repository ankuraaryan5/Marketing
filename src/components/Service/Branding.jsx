...
import { FaPalette, FaChessKnight, FaLightbulb, FaBuilding, FaSwatchbook, FaUsers } from 'react-icons/fa';
      ...
      <div className="relative bg-gray-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Transform Your <span className="text-indigo-400">Brand Identity</span>
          </h1>
          <p className="mt-6 text-xl text-indigo-100 max-w-3xl mx-auto">
            We craft memorable brand experiences that resonate with your audience and differentiate you from competitors.
          </p>
          <div className="mt-10">
            <a
              href="#contact"
            ...
            {[
              {
                icon: FaPalette,
                title: 'Logo Design',
                description: 'Distinctive logos that capture your brand essence and make a lasting impression.',
                link: '/logo-design',
                features: [
              ...
              },
              {
                ...
                description: 'Complete visual identity system including color palette, typography, and design elements.',
                link: '/brand-identity',
                features: [
              ...
              },
              {
                ...
                description: 'Strategic foundation for your brand including positioning, messaging, and voice.',
                link: '/brand-strategy',
                features: [
              ...
              },
              {
                ...
                description: 'Professional branding solutions for businesses and organizations of all sizes.',
              ...
              <div key={index} className="flex flex-col rounded-lg shadow-lg overflow-hidden border border-gray-200 hover:border-indigo-300 transition-all duration-300">
                <div className="flex-1 bg-white p-6 flex flex-col justify-between">
                  <div className="flex-1">
                    <div className={`flex items-center justify-center h-12 w-12 rounded-md ${service.color} bg-indigo-50 mx-auto`}>
                  ...
                  {[
                    {
                      ...
                      description: 'We dive deep into your business, market, and audience to uncover key insights.',
                    },
                    {
                      number: '02',
                      title: 'Strategy Development',
                      description: 'Crafting your brand positioning, personality, and messaging framework.',
                    },
                    {
                      number: '03',
                      title: 'Design Exploration',
                      description: 'Creating visual concepts that bring your brand strategy to life.',
                    },
                    {
                      number: '04',
                      title: 'Refinement',
                      description: 'Iterating based on feedback to perfect your brand identity.',
                    },
                    {
                      number: '05',
                      title: 'Implementation',
                      description: 'Developing all brand assets and guidelines for consistent application.',
                    },
                  ].map((step, index) => (
                    <div key={index} className="relative group">
                      ...
                      <div className="relative z-10 flex items-start">
                        <span className="text-indigo-600 font-bold mr-4">{step.number}</span>
                        <div>
            ...
            {[
              {
                ...
                description: 'Consistent, professional branding makes your business instantly recognizable.',
                stat: '80%',
                statLabel: 'More memorable to consumers'
              },
              {
                title: 'Competitive Edge',
                description: 'Stand out in crowded markets with distinctive brand identity.',
                stat: '3x',
                statLabel: 'Higher perceived value'
              },
              {
                title: 'Customer Loyalty',
                description: 'Strong brands build emotional connections that drive repeat business.',
                stat: '68%',
              ...
              <div key={index} className="bg-white p-6 rounded-lg shadow-md border-t-4 border-indigo-500">
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  <p className="text-3xl font-bold text-indigo-600">{benefit.stat}</p>
      ...
      <div className="bg-indigo-700">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            ...
            <span className="block text-indigo-200">Let's create something remarkable together.</span>
          </h2>
