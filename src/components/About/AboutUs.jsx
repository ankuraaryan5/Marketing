    ...
    <div className="bg-white">
      ...
      <section className="relative pt-32 pb-20 md:pb-32 overflow-hidden bg-gradient-to-br from-green-900 to-green-700">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Digital Excellence <span className="text-green-300">Engineered</span> for Growth
            </motion.h1>
            <motion.p 
              variants={itemVariants} 
              className="text-xl md:text-2xl text-green-100 max-w-3xl mx-auto"
            >
              We combine cutting-edge technology with creative strategy to build digital experiences that convert.
            </motion.p>
            <motion.div 
              variants={itemVariants} 
          ...
          >
            <motion.div variants={itemVariants} className="order-2 md:order-1">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                <span className="text-green-600">Results-Driven</span> Digital Transformation
              </h2>
              <p className="text-lg text-gray-600 mb-6">
                At Adonomics, we don't just build websites - we engineer digital growth systems. Our data-backed approach combines technical excellence with creative strategy to deliver measurable business impact.
              </p>
            ...
            >
              <div className="relative rounded-xl overflow-hidden shadow-2xl aspect-video">
                ...
                <div className="absolute bottom-0 left-0 p-6 text-white">
                  <p className="text-sm font-medium">Crafting Digital Success Stories Since 2015</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section className="py-20 bg-green-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { value: "200+", label: "Successful Projects", color: "green-600" },
              { value: "98%", label: "Client Retention", color: "green-700" },
              { value: "3.2x", label: "Average ROI", color: "green-600" },
              { value: "24/7", label: "Dedicated Support", color: "green-700" }
            ].map((stat, index) => (
              <motion.div 
                key={index}
                variants={itemVariants} 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Our <span className="text-green-600">Proven Process</span></h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
              {[
                { 
                  ...
                  title: "Discovery",
                  content: "Deep dive into your business objectives and audience needs",
                  step: "01"
                },
                { 
                  icon: (
      ...
      style={{ 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl font-bold text-white mb-4">Meet Our <span className="text-green-600">Leadership</span></h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Client <span className="text-green-600">Success Stories</span></h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="mt-6 flex items-center justify-center">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-gray-600">4.9/5 (120+ Reviews)</span>
              </div>
            </div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                quote: "Adonomics transformed our e-commerce platform with their technical expertise. The new site loads 3x faster, has a seamless checkout process, and integrates perfectly with our inventory system. Our conversion rates increased by 40% within the first quarter post-launch.",
                name: "Rajesh Kumar",
                company: "UrbanCraft Homes",
                avatar: "https://plus.unsplash.com/premium_photo-1661637743614-a0aea42073c1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8aW5kaWFuJTIwYm95fGVufDB8fDB8fHww"
              },
              {
                quote: "The digital marketing strategy developed by Adonomics delivered exceptional ROI. Their data-driven approach to PPC campaigns reduced our customer acquisition costs by 35% while increasing quality leads. The team's transparency and regular reporting gave us complete confidence in their work.",
                name: "Priya Sharma",
                company: "GreenLeaf Organics",
                avatar: "https://images.unsplash.com/photo-1617009762269-c062aaf6b3a0?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fGluZGlhbiUyMGdpcmx8ZW58MHx8MHx8fDA%3D"
              }
              ...
              >
                <div className="absolute -top-5 left-6 text-6xl text-green-200 font-serif">"</div>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-green-800 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Accelerate Your Digital Growth?</h2>
            <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
              Let's discuss how we can help you achieve your business objectives through strategic digital solutions.
            </p>
