      ...
      <section className="relative bg-gray-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Professional Social Media Management by <span className="text-emerald-600">Adonomics Technologies</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-12">
            <div className="mb-8 lg:mb-0">
              <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
                Social Media Marketing by <span className="text-emerald-600">Adonomics Technologies</span>
              </h2>
              <div className="mt-6 space-y-6 text-lg text-gray-600">
                <p>
                  In today's fast-paced digital world, your audience isn't just browsing social media—they're living on it. From Instagram stories to LinkedIn posts, your customers are online, scrolling, and engaging with brands they love. If you're not part of that conversation, you're missing out on a massive opportunity. That's where Adonomics Technologies steps in.
                </p>
                <p>
            ...
            <div className="bg-emerald-50 p-8 rounded-xl">
              <h3 className="text-2xl font-bold text-gray-900">Strategy Meets Creativity</h3>
              <div className="mt-4 space-y-4 text-gray-600">
                <p>
                  At Adonomics Technologies, we believe in strategy-first marketing. We start by digging deep into your brand identity, audience behavior, and business goals. Then we craft a custom content plan that aligns with your vision. But we don’t stop there. Our creative team brings each campaign to life with scroll-stopping visuals, magnetic captions, and thumb-stopping videos that make people pause, engage, and take action.
                </p>
                <p>
                  We work across all major platforms: <strong>Instagram, Facebook, LinkedIn, X (Twitter), Pinterest, YouTube, Threads & emerging platforms.</strong>
                </p>
              ...
              {[
                {
                  ...
                  description: "Professional graphics, videos, and copywriting tailored to your brand voice.",
                  icon: FaPenFancy,
                  iconColor: "text-emerald-600 bg-emerald-50"
                },
                {
                  title: "Post Scheduling",
                  description: "Strategic scheduling for optimal engagement times across all platforms.",
                  icon: FaCalendarAlt,
                  iconColor: "text-blue-600 bg-blue-50"
                },
                {
                  title: "Community Management",
                  description: "Daily monitoring and engagement to build brand loyalty.",
                  icon: FaUsers,
                  iconColor: "text-purple-600 bg-purple-50"
                },
                {
                  title: "Paid Advertising",
                  description: "Targeted social media ad campaigns to maximize ROI.",
                  icon: FaBullseye,
                  ...
                  {[
                    {
                      ...
                      description: "We analyze your business, competitors, and audience to create a customized strategy."
                    },
                    {
                      number: "02",
                      title: "Content Planning",
                      description: "Monthly content calendars aligned with your marketing goals."
                    },
                    {
                      number: "03",
                      title: "Creative Development",
                      description: "Our team produces engaging, platform-optimized content."
                    },
                    {
                      number: "04",
                    ...
                    },
                    {
                      ...
                      description: "Continuous performance tracking and refinement."
                    }
                  ].map((step, index) => (
              ...
              <div className="mt-12 lg:mt-0 lg:w-1/2">
                <div className="bg-white p-6 rounded-xl shadow-lg">
                  ...
                  <div className="mt-6 p-4 bg-emerald-50 rounded-lg">
                    ...
                    <p className="mt-2 text-gray-600">
                      Our systematic approach ensures consistency, quality, and measurable results for your social media presence.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-full text-xl text-gray-600 mx-auto">
              We’re not your average agency. Adonomics Technologies is built by real marketers, designers, and analysts who care about results. We work with businesses that want more than just "posting online." Our clients are looking to make real connections with their audience—and drive actual business outcomes.
              We’ve helped fashion brands grow their Instagram by over 200% in just 6 months. We’ve driven leads for B2B firms through targeted LinkedIn campaigns that resulted in thousands of dollars in sales overnight.
      ...
      <section className="bg-emerald-600">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 max-w-full text-xl text-emerald-100 mx-auto">
            Let us be your voice on social media. Whether you’re starting from scratch or tired of inconsistent posting and zero engagement, we’ll bring the spark your brand needs. Book a free discovery call with the team at Adonomics Technologies today—and let’s make your social media unstoppable.
          </p>
